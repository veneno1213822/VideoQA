...
if __name__ == '__main__':
    ...
    parser.add_argument('--pred_jsonl', default="./output_example/msvd_test/gpt_response/"+INPUT_NAME+".jsonl", help="prediction jsonl")
    parser.add_argument('--idx_2_video_id', default="./output_example/msvd_test/input_prompts/"+INPUT_NAME+"__idx_2_videoid.json", help="idx_2_video_id")
    parser.add_argument('--ans2label', default="", help="ans2label")
    # 测试集答案
    parser.add_argument('--gt', default="shared_datasets/msvd_qa/ann/test.jsonl", help="ground truth jsonl'")
    # 测试集答案的集合(所有不重复的词)
    parser.add_argument('--answer_list_json', default="shared_datasets/msvd_qa/ann/test_answer_list.json", help="required if evaluating generation results'")
    parser.add_argument('--setting', default="generation_gpt3_raw", help="'ranking' or 'generation', 'generation_gpt3_raw', 'alpro'")
